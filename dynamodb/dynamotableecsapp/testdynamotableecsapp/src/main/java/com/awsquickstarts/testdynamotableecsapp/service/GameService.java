package com.awsquickstarts.testdynamotableecsapp.service;
...
import com.awsquickstarts.testdynamotableecsapp.repository.IGameRepository;
...
public class GameService {
    ...
    public GameTo findById(final String id) {
