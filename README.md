...
- [apigatewayapikeyusageplan] - An API Gateway with usage plan and API Key configured
- [apigatewaydomainnamebasepath] - An API Gateway with domain name and base path
- [apigatewaylambda] - A public API Gateway and a Lambda function as backend
- [apigatewaylambdaauthorizer] - An API Gateway with a Lambda function as authorizer
- [apigatewaymock] - An API Gateway with a mocked backend
- [apigatewayprivateloadbalancer] - A private API Gateway integrated with a Network Load Balancer and an ECS task
