...
- [apigatewayecsappgamerestapi] - Complete CRUD REST API using CloudFront in front of an API Gateway, a Load Balancer in front of an ECS task as backend, a Lambda function as authorizer and a RDS MySQL table `backlog`
