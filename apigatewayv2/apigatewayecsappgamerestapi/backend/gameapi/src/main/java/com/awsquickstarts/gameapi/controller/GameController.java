...
import com.awsquickstarts.gameapi.model.to.ErrorTo;
...
public class GameController {
    ...
    @GetMapping(path = "/{id}")
    public ResponseEntity<Object> getGamesById(@PathVariable(name = "id", required = true) Long id) {
    ...
    @PutMapping(path = "/{id}")
    public ResponseEntity<Object> putGamesById(@PathVariable(name = "id", required = true) Long id,
